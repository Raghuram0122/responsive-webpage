    ...
    return (
        <div className="mt-[60px] p-6 ml-4 lg:ml-[40px]">
            <div className="flex justify-start items-center">
                ...
                <button className="text-[12px] font-medium underline text-gray-800" onClick={() => window.location.href = "#"}>
                    View All
                </button>
            </div>
            <ul className="flex flex-col mt-[70px] mb-10">
                <div className="flex justify-between items-center">
                    ...
                    <button className="underline font-sans text-[10px] text-gray-500" onClick={() => window.location.href = "#"}>
                        Read More
                    </button>
                </div>
            </ul>
