        ...
        <div className="p-4 ml-3 lg:ml-[40px]">
            ...
            <nav className="p-3 ">
                <ul className="flex font-sans">
                    <li className="text-blue-600 pr-4"><button className="focus:outline-none" onClick={() => window.location.href = '#'}>Press Room</button></li>
                    <li className="pr-4 border-l-stone-900 border-l-2 pl-4">
                        <button className="focus:outline-none" onClick={() => window.location.href = '#'}>Press Releases</button>
                    </li>
                    <li className="border-l-stone-900 border-l-2 pl-4"><button className="focus:outline-none" onClick={() => window.location.href = '#'}>In The News</button></li>
                </ul>
            </nav>
            <hr className="h-0.5 mx-auto my-4 bg-zinc-600" />
